...
from app.routers import action_items, health, meetings, people, search, support, voiceprint_admin
...
def create_app() -> FastAPI:
    ...
    app.include_router(voiceprint_admin.router, prefix=settings.api_v1_prefix)
    return app
