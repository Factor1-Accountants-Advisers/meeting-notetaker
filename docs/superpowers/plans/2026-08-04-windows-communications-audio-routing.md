...
- [x] **Step 1: Write the failing protocol fixture**
...
- [x] **Step 3: Implement strict shared types and parser**
...
- [x] **Step 4: Add and run `verify:audio-endpoint-protocol`**
...
- [x] **Step 1: Write failing Rust change-detection tests**
...
- [x] **Step 3: Implement the pure protocol core**
...
- [x] **Step 4: Implement the Windows provider and polling binary**
...
- [x] **Step 5: Verify helper tests and a live snapshot**
...
- [x] **Step 1: Write failing service fixture**
...
- [x] **Step 3: Implement service and helper path resolution**
...
- [x] **Step 4: Register IPC and lifecycle**
...
- [x] **Step 6: Verify service, preload typing, and typecheck**
...
- [x] **Step 1: Write failing preference/resolution fixture**
...
- [x] **Step 3: Implement versioned preferences**
...
- [x] **Step 4: Implement route resolution**
...
- [x] **Step 5: Verify fixture and web typecheck**
...
- [x] **Step 1: Add failing pinned-reappearance fixture**
...
- [x] **Step 2: Add failing native endpoint and silence-recovery fixtures**
...
- [x] **Step 3: Run fixtures and verify RED**
...
- [x] **Step 4: Change `CaptureController.start` to accept a route object**
...
- [x] **Step 5: Implement correct pinned comparison and native subscriptions**
...
- [x] **Step 6: Implement bounded silence recovery**
...
- [x] **Step 7: Update App capture calls**
...
- [x] **Step 8: Verify GREEN and typechecks**
...
- [x] **Step 1: Write failing static UI fixture**
...
- [x] **Step 3: Implement live Settings routing UI**
...
- [x] **Step 4: Implement compact recording labels and warnings**
...
- [x] **Step 5: Verify fixture and build**
...
- [x] **Step 1: Write failing packaging verification**
...
- [x] **Step 2: Run script and verify RED**
...
- [x] **Step 3: Add build and packaging configuration**

Add `build:audio-helper` and make `package:dir` build the release helper first.
Add `extraResources` in the base builder config; the Azure config extends and
inherits it so it must not replace the resource list. Keep the helper out of
ASAR and under the service's exact packaged path.

- [x] **Step 4: Add CI helper build and signature checks**

Install/pin the stable Rust toolchain in the Windows release job, run Cargo
tests/build, verify the source helper before installer creation, and verify the
unpacked helper after packaging. After Azure Artifact Signing, use
`Get-AuthenticodeSignature` on the app and helper executable and require a
Factor1 signer plus timestamp. The runner does not trust the private root, so a
chain status other than `Valid` is permitted there; managed-device acceptance
validates the private-trust chain.

- [x] **Step 5: Verify local packaged directory**
...
- [x] **Step 1: Document operational behaviour**
...
- [x] **Step 2: Mark completed plan checkboxes and run all repository gates**
